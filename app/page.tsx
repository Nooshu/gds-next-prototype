    ...
    <>
      ...
      <main className="govuk-main-wrapper" id="main-content" role="main">
        <GovContainer>
          ...
          {searchParams?.error && (
            <div className="govuk-error-summary" role="alert" aria-labelledby="pe-error-title">
              <h2 id="pe-error-title" className="govuk-error-summary__title">There is a problem</h2>
